...
if __name__ == "__main__":
    ...
    # Set context
    logger.set_context(session_uuid="12345678-1234-1234-1234-123456789abc", caller="+14155552671")
    
    # Example usage
    logger.audiosocket_server_started("127.0.0.1", 9092)
    logger.audiosocket_connection_accepted("72.60.202.148", 54321)
    logger.uuid_received("12345678-1234-1234-1234-123456789abc")
    logger.call_direction_detected("inbound")
    logger.greeting_generation_started("Hello, this is an AI assistant. How can I help?")
    logger.tts_completed(1234, 12345, "slin16")
    logger.audio_stream_started(12345, 2048)
    logger.audio_chunk_sent(1, 0, 2048, 2048)
    logger.audio_stream_completed(6, 12288, 800)
    logger.input_waiting()
    logger.audiosocket_connection_closed("call_ended", 45000)
